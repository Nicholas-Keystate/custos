...
| id | finding | site |
|---|---|---|
| V3-1 | GF-5 | s8.2 window-open cure (1) |
| V3-2 | GF-5 | s8.2 window-open cure (2) |
| V3-3 | GF-5 | s8.4 force distinction |
| V3-4 | GF-5 | s19 closing protections |
| V3-5 | GF-2 | s17 walls count |
| V3-6 | GF-2 | appendix collision census closing |
| V3-7 | GF-3 | s19 bundle-preimage per-group rule |
| V3-8 | GF-4 | s7 aggregate-Constitution head |
